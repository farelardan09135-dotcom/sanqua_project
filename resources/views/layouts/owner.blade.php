    ...
    <div class="min-h-screen w-full bg-linear-to-b from-sky-200 via-sky-100 to-blue-50 flex">
        ...
        <aside class="w-64 shrink-0 bg-linear-to-b from-blue-600 to-sky-500 flex flex-col shadow-2xl">
            ...
            <nav class="flex-1 px-4 py-6 space-y-1.5">
                ...
                class="flex items-center gap-3 px-4 py-3 rounded-xl transition-colors duration-200 {{ request()->routeIs('owner.setting') ? 'bg-white text-indigo-800 shadow-md font-semibold' : 'text-indigo-100 hover:text-white' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
